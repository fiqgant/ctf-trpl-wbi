...
- Online endpoints:
  - `GET /api/level10`
  - `GET /api/level10/pieces?ticket=...`
  - `POST /api/level10/submit`
...
curl "https://ctf-trpl-wbi.vercel.app/api/level10/pieces?ticket=<edited-ticket>"
curl -X POST https://ctf-trpl-wbi.vercel.app/api/level10/submit \
